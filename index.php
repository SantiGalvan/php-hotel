...
if ($vote) {
    ...
    foreach ($hotels as $hotel) {
        if ($hotel['vote'] >= $vote) $filtered_hotels[] = $hotel;
                ...
                <div class="form">
                    <form action="" method="get" class="d-flex align-items-center gap-4">
                        <div class="d-flex align-items-center justify-content-end gap-3">
                            <label for="vote" class="form-label m-0">Rating</label>
                            <input type="number" class="form-control" id="vote" name="vote" min="1" max="5" value="<?= $vote ?? 1 ?>">
                        </div>
